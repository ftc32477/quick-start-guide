...
2. **封二（版权页）**：白底排版、内容置于页面下部，含完整书名、**版次（2026年8月第1版）**、**版本号（v1.0.0）**、**发布日期（2026年8月14日）**、语言版本、主编/编写人员、出品方与地址，以及完整法律声明；数据取自 `VERSIONS` 最新已发布条目，随发版自动更新
...
| 勘误：错别字/样式/小修正 | 编写人员名单、法律声明 | 修订 +1 → v1.1.1 | 第1版·第2次修订 |
