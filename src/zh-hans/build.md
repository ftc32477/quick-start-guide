...
- 运行 Bambu Studio。登录区域请选择"中国内地（大陆）"，打印机请至少选择 **Bambu Lab P1S** 和 **Bambu Lab P2S**，材料按默认配置即可。请勾选"安装 Bambu 网络插件"。
...
| **goBILDA** | C 型梁、方梁或薄梁，8mm REX 轴，各种单位化的连接件，连接功能完善。主要采用 M4 螺丝（官方 10mm），电机多为 5203 系列。适用于电机直传的套件。 |
...
1. **零件采购**
   - FTC 官方器材供应商位于境外，采购工期长、价格高；非刚需材料可在国内平台寻找平替，兼顾成本与交付速度
2. **自制件制作**
   - 3D 打印件制作
   - 激光切割板材加工
3. **硬件安装**
...
| 打印机 | 喷嘴 | 耗材 |
|--------|------|------|
| P1S（未更换喷嘴） | 0.4 mm | PLA Basic |
| P1S（已更换喷嘴，专门打印碳材） | 0.6 mm | PETG-CF |
| P2S（两台） | 0.4 mm | PLA Basic |
...
> [!info] 以上参数均为我队的常用配置，如有特殊需求可自行修改。
