...
- **Editor-in-chief**: Fu Xiuqi (付修齐)
- **Writers**: Du Xingzhou (杜星洲), Xie Jincan (谢金灿), et al.

The compilation of this guide was made possible with help from many people.

We thank Beijing National Day Experimental School for its strong support, Teacher Zou Shusen (邹书森) for technical guidance, and Teacher Dong Ying (董莹) for material support.

We would especially like to thank Huang Tianlin (黄天霖) for photography guidance and Wang Jingyu (王景钰) for image editing guidance.

Reference: *General Senior High School Textbook — Physics, Compulsory Volume 3 (普通高中教科书 物理 必修 第三册)*
...
In the new season, let us uphold professionalism, experiment boldly, and verify carefully.
...
- **President**: Du Xingzhou (杜星洲)
- **Hardware**: Xie Jincan (谢金灿), Shi Yuguang (时宇光), Jiang Yichen (姜易辰), Xue Chen (薛晨), Du Fengyu (杜丰宇)
- **Programming**: Du Xingzhou (杜星洲), Fu Xiuqi (付修齐), Zhang Xipeng (张熙芃), Liu Chuyi (刘楚翌)
- **Outreach**: Han Zixuan (韩子萱), Chen Xibei (陈西贝), Li Jiaoyang (李骄洋), Liu Yuxuan (柳宇轩), Wang Yizhou (王一舟)
...
*Compiled by the 32477 Origin Quick Start Guide Editorial Team · September 2026, 3rd Edition*
